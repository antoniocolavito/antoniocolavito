...
#QUERY 6 // Seleziono le società all'interno degli utanti
select = 'rag_soc'
frm = 'utente'
join1 = None
join2 = None
...
qsql6 = query(select,frm,join1,join2,where,groupby,orderby)
print(qsql6)
cursor.execute(qsql6)
q6 = cursor.fetchall()
print('Query 6: ', q6)
qpandas6 = datafrane(qsql6)
print('Query 6 in Pandas è:', qpandas6)
